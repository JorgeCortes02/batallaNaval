...
// Verificar si los valores han sido recibidos correctamente
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $specialAttack = isset($_POST['specialAtack']) && $_POST['specialAtack'] == "true" ? true : false;
    var_dump($specialAttack);
}
...
<body class="page-game">
                ...
                if ($orientation == 0) {
                    ...
                    if ($freePosition == true) {
                        ...
                        for ($j = 0; $j < $horder[1]; $j++) {
                            ...
                            $arrayPosiciones[$row][$column + $j] = "$horder[1],$countHorder,$j";
                    ...
                    if ($freePosition == true) {
                        ...
                        for ($j = 0; $j < $horder[1]; $j++) {
                            // Mark the ship's positions in the array with its length.
                            $arrayPosiciones[$row + $j][$column] = "$horder[1],$countHorder,$j";
    ...
    <?php echo "<script> var ammoEnabled = '$munition'; var extraArmor = '$armor';  var grenadeEnabled = '$specialAttack';</script>" ?>
    <!-- Easter egg box generated by clicking on [0,0] in enemyTable generated -->
